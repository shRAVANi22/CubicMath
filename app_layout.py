...
layout = html.Div(children=[
    html.Div([
        "Select Cube",
        dcc.Dropdown(['Ideal Cube', 'Scrambled_Robot'], 'Ideal Cube', id='cube_dropdown')]),
    html.Div([dbc.Button("Reset", id="reset", n_clicks=0, style={'background-color': 'black', 'color': 'white'})]),
    # html.Div([
